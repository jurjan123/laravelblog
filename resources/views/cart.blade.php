                ...
                <tbody>
                  @foreach(session("cart") as $id => $details)
                    <tr class=" fs-9">
                        ...
                        <td class="py-2 px-3 border-b "><img src="{{url("images/".$details["image"])}}" width="500" height="100" alt=""></td>
                        ...
                        <td class=""><i class="bi bi-currency-euro"></i>{{str_replace(".", ",", $details["price"])}}</td>
