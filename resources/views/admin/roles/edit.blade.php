<x-app-layout>
    ...
    <div class="row">
        ...
        <div class="card ml-2 p-3 ">
            <form action="{{route("admin.roles.update", $value)}}" method="post" >
                @method("PUT")
                @csrf
                ...
                <div class="mb-3">
                    <div class="mb-3 ">
                        ...
                        <div class="input-group mb-3  py-2 ">
                            ...
                            <input type="text" value="{{$value->name}}"   name="name" class=" error form-control ml-5 mt-4 w-100 position-absolute @error('title') is-invalid  @enderror" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                          </div>
