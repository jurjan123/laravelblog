                ...
                <div class="mb-3">
                    <div class="mb-3 ">
                        ...
                        <div class="input-group mb-3  py-2 ">
                            ...
                            <input type="text" @if($errors->any())value="{{old("title")}}" @else value="{{$title}}" @endif name="title" class="form-control ml-5 mt-4 w-100 position-absolute @error('title') is-invalid  @enderror" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                          </div>
                          @error("title")
