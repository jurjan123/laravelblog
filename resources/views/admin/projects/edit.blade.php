                ...
                <div class="mb-3">
                    <div class="mb-3 ">
                        ...
                        <div class="input-group mb-3  py-2 ">
                            ...
                            <input type="text" value="{{$intro}}"  name="intro" class="form-control ml-5 mt-4 w-100 position-absolute" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                          </div>
                          @error("intro")
                        <p class="text-red-500 text-xs mt-1">{{$message}}</p>
                        @enderror
