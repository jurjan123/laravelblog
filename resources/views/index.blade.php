...
<body>
    <nav class="navbar navbar-expand-sm position-relative justify-content-between navbar-light bg-light py-3">
        <a style="padding-left: 30px" class="navbar-brand" id="naam">movieBlog</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto"> 
            ...
            <div class="ms-auto " id="registerAndlogin">
            <li class="nav-item text-right">
                <a href="/register" class="nav-link" id="logo">register</a>
                <i class="fa-regular fa-id-card " width="50" height="50"></i>
            </li>
            <li class="nav-item text-right" >
                <a href="/login" class="nav-link" id="logo">login</a>
    ...
    <div class="maincontent" class="container my-5">
        <div class="text">
        <h2>rules</h2>
        <p>1. Cite Your Sources
        ...
        <p>2. Disclose Paid Endorsements
